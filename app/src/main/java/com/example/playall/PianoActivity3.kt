...
import com.example.playall.databinding.ActivityPiano3Binding

class PianoActivity3 : AppCompatActivity() {

    private lateinit var binding: ActivityPiano3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPiano3Binding.inflate(layoutInflater)
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.size_menu3, menu)
