...
import com.example.playall.databinding.ActivityPiano2Binding

class PianoActivity2 : AppCompatActivity() {

    private lateinit var binding: ActivityPiano2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPiano2Binding.inflate(layoutInflater)
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.size_menu2, menu)
