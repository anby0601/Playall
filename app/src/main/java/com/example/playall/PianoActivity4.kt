...
import com.example.playall.databinding.ActivityPiano4Binding

class PianoActivity4 : AppCompatActivity() {

    private lateinit var binding: ActivityPiano4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPiano4Binding.inflate(layoutInflater)
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.size_menu4, menu)
